...
const droneFaqs = [
  {
    q: "What can drone photography be used for?",
    a: "Drone photography is ideal for real estate, events, venues, architecture, and landscape projects where elevated perspective adds scale and visual impact.",
  },
  {
    q: "Are your drone shoots compliant with local regulations?",
    a: "Yes. We follow applicable drone operation guidelines and perform pre-flight planning to ensure safe and compliant shoots at approved locations.",
  },
  {
    q: "Can you combine aerial and ground photography?",
    a: "Absolutely. We can combine drone and ground coverage for a complete visual package that gives both context and detailed storytelling.",
  },
  {
    q: "What affects drone shoot availability?",
    a: "Weather conditions, airspace restrictions, and location permissions can affect scheduling. We always confirm feasibility before your shoot date.",
  },
  {
    q: "How are final drone photos delivered?",
    a: "Final images are delivered in high-resolution edited formats suitable for listings, presentations, social media, and marketing campaigns.",
  },
];
...
export default function DronePhotographyFAQ() {
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <motion.div ref={headerRef} initial={{ opacity: 0, y: 18 }} animate={headerInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.55 }} className="mx-auto mb-10 max-w-2xl text-center sm:mb-12">
          ...
          <p className="text-sm text-stone-500 sm:text-[15px]" style={{ fontFamily: inter }}>
            Common questions before booking aerial photography.
          </p>
        </motion.div>
        ...
        <motion.p initial={{ opacity: 0 }} animate={headerInView ? { opacity: 1 } : {}} transition={{ delay: 0.35, duration: 0.5 }} className="mt-10 text-center text-sm text-stone-600" style={{ fontFamily: inter }}>
          Need a custom aerial coverage plan?{" "}
