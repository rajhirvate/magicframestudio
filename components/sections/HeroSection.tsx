    ...
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 sm:px-6 max-w-5xl w-full mx-auto">
        ...
        >
          <Link
            href="/portfolio"
            className="group inline-flex items-center gap-2.5 px-7 py-3.5 text-sm font-medium text-[#f5f0eb] border border-[#f5f0eb]/25 hover:border-[#f5f0eb]/60 rounded-none transition-all duration-300 hover:bg-white/5 backdrop-blur-sm"
