...
const productFaqs = [
  {
    q: "What types of product photography do you offer?",
    a: "We cover e-commerce white-background shots, lifestyle setups, catalog photography, jewelry, food, and commercial product campaigns tailored to your platform.",
  },
  {
    q: "Can you shoot large product catalogs?",
    a: "Yes. We handle both small and high-volume SKU batches with a standardized workflow so lighting, angles, and quality remain consistent across the catalog.",
  },
  {
    q: "Do you follow Amazon and Flipkart image requirements?",
    a: "Absolutely. We can align output with marketplace guidelines, including background standards, framing, and file formats needed for listing approval.",
  },
  {
    q: "Do you provide retouching and color correction?",
    a: "Yes. All selected images include professional editing for color accuracy, cleanup, and polish while keeping product details natural and trustworthy.",
  },
  {
    q: "How quickly will we receive final images?",
    a: "Turnaround depends on product count and complexity, but we provide clear delivery timelines before the shoot and can prioritize urgent launches when needed.",
  },
];
...
export default function ProductPhotographyFAQ() {
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-sm text-stone-500 sm:text-[15px]" style={{ fontFamily: inter }}>
            Common questions before booking product shoots.
          </p>
        </motion.div>
        ...
        <motion.p
          ...
          style={{ fontFamily: inter }}
        >
          Need a custom product shoot quote?{" "}
