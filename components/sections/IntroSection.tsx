    ...
    >
      <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:max-w-6xl lg:px-8">
        ...
        <motion.p
          ...
          className="mx-auto mb-10 max-w-4xl text-[10px] font-semibold uppercase leading-relaxed tracking-[0.22em] text-[#5c6570] sm:text-[11px]"
          style={{ fontFamily: sans }}
        >
        ...
        <motion.p
          ...
          className="mx-auto mb-12 max-w-5xl text-[15px] leading-[1.85] text-stone-500 lg:text-base lg:leading-[1.9]"
          style={{ fontFamily: sans }}
        >
