    ...
    >
      ...
      >
        <div className="aspect-[3/2] relative overflow-hidden bg-stone-100">
          ...
          <div className="absolute bottom-3 right-3 flex items-center gap-1.5 bg-white/95 backdrop-blur-sm rounded-full px-3 py-1.5 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300 shadow-md">
            <span
    ...
    <>
      ...
      <section className="relative py-16 lg:py-20 bg-[#0a0a0a] overflow-hidden border-t border-stone-800/80">
        ...
        <div className="relative max-w-3xl mx-auto px-4 text-center">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-9 py-3.5 text-sm font-semibold text-[#0a0a0a] bg-[#c9a84c] hover:bg-[#e0c068] rounded-full transition-colors duration-200 shadow-lg shadow-[#c9a84c]/20"
            style={{ fontFamily: poppins }}
          >
            Get a free quote
          </Link>
